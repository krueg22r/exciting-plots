...
class formatObj(object): 
	def __init__(self, grayscale = 0, colorCounter = 0, markerCounter = 0): 
		...
		self.markers = ['o', 'v', 'd', 'X', 's', '>', 'p', '8', '^', 'P', '<', '*']
		self.grayscale = ['#f7f7f7', '#cccccc', '#969696', '#636363', '#252525']
		#self.colors = ['#6c6fb8', '#668e43', '#9d49c7', '#be5e35', '#bd4a78']
		#self.colors = ["#b65836", "#6f82da", "#7fa443", "#663c8f", "#50b47b", "#c868b1", "#c3973c", "#b54361", 'black']
		#self.colors =[ "#6e82da", "#9ab13f", "#57398c", "#5aa554", "#c071c9", "#45c097", "#b34f8e", "#ce9638", "#bb486a", "#95893e", "#bb4545", "#bb6036"]
...
def plotSpline(x, y, curveColor): 
	...
	print('min y = '+str(np.amin(yNew)))
	print('rmin = '+str(xNew[np.argmin(yNew)]))
